  ...
  var Container = function (_BaseClass) {
    ...
    function Container(props, context) {
      ...
      _this._stores = _this._stores.map(function (Store) {
        ...
        return new Store(_this._dispatcher);
      });
       ...
       * @type {object}
       */
      _this.state = _get(Object.getPrototypeOf(Container.prototype), 'calculateState', _this).call(_this);

      /**
       * Merge with initial state if any
       */
      Object.assign(_this.state, initState);
      return _this;
    }
